...
public class TagConfigOperationDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        scrollPane.setBorder(
                new CompoundBorder(new EmptyBorder(5, 15, 5, 15), new LineBorder(new Color(200, 200, 200), 1)));
        ...
        // Use DialogUtilities for consistent button styling
        DialogUtilities.stylePrimaryButton(confirmButton);
