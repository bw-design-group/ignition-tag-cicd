...
You have two ways to export tags:

### Standard Export (Using Configuration Manager)

To export tags using your saved configuration:
...
### Selective Export (Quick Export)

For quick, targeted exports without selecting configurations:

1. Click the 🔍 **Selective Export** button in the Tag CICD toolbar
2. Select the tag provider from the dropdown
3. Browse and select the specific tag path you want to export
4. The system will automatically find configurations that match your selection
5. Click **Export Selected Path** to run all matching configurations

This is perfect for exporting just the tags you're working on during development or testing.
