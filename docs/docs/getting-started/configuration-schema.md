...
```json
{
    ...
    "items": {
        ...
        "properties": {
            ...
            "baseTagPath": {
                "type": "string",
                "description": "The base tag path to export from or import to. Can be empty string for provider root, or a path like 'Production/Line1'. Special value '_types_' targets UDT definitions."
            },
            "sourcePath": {
                "type": "string",
            ...
            "skipStartupImportIfTagsExist": {
                "type": "boolean",
                "description": "Whether to skip importing on startup if tags already exist in the baseTagPath",
                "default": false
            }
        }
    }
...
Here's an example `export-config.json` that conforms to the schema and shows different usage patterns:
...
[
    {
        "provider": "default",
        "baseTagPath": "",
        "sourcePath": "data/tags/full-backup.json",
        "collisionPolicy": "o",
        "exportMode": "singleFile",
        "skipStartupImportIfTagsExist": true
    },
    {
        "provider": "default",
        "baseTagPath": "_types_",
        "sourcePath": "data/tags/udt-definitions",
        "collisionPolicy": "o",
    ...
    },
    {
        "provider": "individual",
        "baseTagPath": "",
        "sourcePath": "data/tags/structured",
        "collisionPolicy": "o",
...
- **`baseTagPath`**: The tag path to export from or import to. Use empty string `""` for provider root, a path like `"Production/Line1"` for specific folders, or `"_types_"` for UDT definitions only. Required.
...
- **`skipStartupImportIfTagsExist`**: If `true`, skips importing on startup if tags already exist in the `baseTagPath`. Defaults to `false`.
