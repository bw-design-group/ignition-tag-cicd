    ...
    [
      'classic',
      {
        docs: {
          ...
          routeBasePath: '/',
          editUrl:
            'https://github.com/bw-design-group/ignition.modules.tag-cicd/tree/master/docs',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/bw-design-group/ignition.modules.tag-cicd',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub Issues',
              href: 'https://github.com/bw-design-group/ignition.modules.tag-cicd/issues',
            },
          ],
        },
        {
